...
-- DB mysql://root:kamiloalca@127.0.0.1:3307/SolarInfo
-- %DB mysql://root:kamiloalca@127.0.0.1:3307/SolarInfo
...
-- CREATE DATABASE IF NOT EXISTS InstitucionDB; USE SolarInfo; 
...
-- Ana en Matemáticas (1, 2, 3.8), -- Ana en Ciencias (2, 1, 4.2), -- Carlos en Matemáticas (3, 3, 3.5), -- María en Historia (4, 4, 4.0), -- Javier en Inglés (5, 2, 4.7); -- Sofía en Ciencias
-- CREATE DATABASE IF NOT EXISTS InstitucionDB; USE InstitucionDB;

-- -- Crear la tabla de Estudiantes 
--
-- CREATE TABLE IF NOT EXISTS
-- Estudiantes ( id_estudiante INT AUTO_INCREMENT PRIMARY KEY, nombre VARCHAR(50) NOT NULL, edad INT(3) NOT NULL, grado VARCHAR(10) NOT NULL ); 
-- -- Insertar datos en Estudiantes 
-- INSERT INTO Estudiantes (nombre,edad, grado) VALUES ('Ana Pérez', 12, '7°'), ('Carlos López', 13, '8°'), ('María Gómez', 11, '6°'), ('Javier Torres', 14, '9°'), ('Sofía Ramírez', 12, '7°');
-- -- Crear la tabla de Profesores 
--
-- CREATE TABLE IF NOT EXISTS Profesores ( id_profesor INT AUTO_INCREMENT PRIMARY KEY, nombre VARCHAR(50) NOT NULL, especialidad VARCHAR(50) NOT NULL );
-- -- Insertar datos en Profesores 
-- INSERT INTO Profesores (nombre, especialidad) VALUES ('Laura Martínez', 'Matemáticas'), ('Pedro Fernández', 'Ciencias'), ('Elena Rojas', 'Historia'), ('Juan Méndez', 'Inglés');
-- -- Crear la tabla de Materias 
-- CREATE TABLE IF NOT EXISTS
-- Materias ( id_materia INT AUTO_INCREMENT PRIMARY KEY, nombre VARCHAR(50) NOT NULL, id_profesor INT, FOREIGN KEY (id_profesor) REFERENCES Profesores(id_profesor) );
-- -- Insertar datos en Materias 
-- INSERT INTO Materias (nombre, id_profesor) VALUES ('Matemáticas', 1), ('Ciencias', 2), ('Historia', 3), ('Inglés', 4);
--
--
...
-- -- Crear la tabla de Calificaciones 
-- CREATE TABLE IF NOT EXISTS
-- Calificaciones ( id_calificacion INT AUTO_INCREMENT PRIMARY KEY, id_estudiante INT, id_materia INT, nota DECIMAL(4,2), FOREIGN KEY (id_estudiante) REFERENCES Estudiantes(id_estudiante), FOREIGN KEY (id_materia) REFERENCES Materias(id_materia) );
--
-- -- Insertar datos en Calificaciones 
--
...
-- NSERT INTO Calificaciones (id_estudiante, id_materia, nota) VALUES (5, 2, 4.7);
-- INSERT INTO Calificaciones (id_estudiante, id_materia, nota) VALUES (5, 2, 4.7);
-- select * from Estudiantes;
--
--
--
-- SELECT id_materia FROM calificaciones WHERE id_estudiante = 1;
--
--
--
-- show TABLES;
